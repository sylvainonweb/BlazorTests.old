...
namespace BlazorTests.Server.Entities.FactoryClasses
{
	...
	{
		private readonly BlazorTests.Server.Entities.EntityType _typeOfEntity;
		...
		{
			return GeneralEntityFactory.Create((BlazorTests.Server.Entities.EntityType)entityTypeValue);
		}
	...
	public partial class CustomerEntityFactory : EntityFactoryBase2<CustomerEntity> {
		/// <summary>CTor</summary>
		public CustomerEntityFactory() : base("CustomerEntity", BlazorTests.Server.Entities.EntityType.CustomerEntity, false) { }
	...
	{
		/// <summary>Gets the factory of the Entity type with the BlazorTests.Server.Entities.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (BlazorTests.Server.Entities.EntityType)Enum.Parse(typeof(BlazorTests.Server.Entities.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation((BlazorTests.Server.Entities.EntityType)Enum.Parse(typeof(BlazorTests.Server.Entities.EntityType), leftOperandEntityName, false), joinType, (BlazorTests.Server.Entities.EntityType)Enum.Parse(typeof(BlazorTests.Server.Entities.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		...
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the BlazorTests.Server.Entities.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((BlazorTests.Server.Entities.EntityType)entityTypeValue);
		}
