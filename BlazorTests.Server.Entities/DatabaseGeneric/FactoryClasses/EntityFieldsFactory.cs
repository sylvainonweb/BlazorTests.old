...
namespace BlazorTests.Server.Entities.FactoryClasses
{
	...
	{
		private static readonly Dictionary<BlazorTests.Server.Entities.EntityType, string> _entityTypeNamesCache = new Dictionary<BlazorTests.Server.Entities.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(BlazorTests.Server.Entities.EntityType value in Enum.GetValues(typeof(BlazorTests.Server.Entities.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(BlazorTests.Server.Entities.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(BlazorTests.Server.Entities.EntityType relatedEntityType)
		{
